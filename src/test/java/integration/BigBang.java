...
public class BigBang {
    ...
    //BigBang
    @Test
    public void main_PABC() throws NoSuchFieldException, IllegalAccessException, IOException {
        //Arrange
        PrintStream out = Mockito.mock(PrintStream.class); //main() returns void so we get the result by mocking system.out
        System.setOut(out);
        BufferedReader console = Mockito.mock(BufferedReader.class);
